...
class Functions:
	...
	def subjectivity(self, text):
		...
		loaded_model = pickle.load(open('resources/NB_Subj_Model.sav', 'rb'))
		# loaded_model = pickle.load('resources/NB_Subj_Model.sav')
		# count_vect = pickle.load(open(os.path.join(DIRNAME, '', 'count_vect.sav'), 'rb'))
		count_vect = pickle.load(open( 'resources/count_vect.sav', 'rb'))
		# tfidf_transformer = pickle.load(open('resources/tfidf_transformer.sav', 'rb'))
		tfidf_transformer = pickle.load(open('resources/tfidf_transformer.sav', 'rb', encoding="utf-8"))
